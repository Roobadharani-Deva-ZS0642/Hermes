...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseStatusPayload<CurrentUser> loginRedirect(@RequestBody @Valid final LoginRequest loginRequest,@RequestHeader(value = "instanceType") String source) {
